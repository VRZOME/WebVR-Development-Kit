/* global canvas, fullScreenButton, lockScreenButton, loopButton, muteButton, playL, playR, playButton, projectionSelect, quat, seekBar, webGL, video, videoSelect, vrHMD, vrSensor */
...
(function(global) {
  ...
  var controls = {
    manualControls: {
      ...
      'w' : {index: 2, sign: 1, active: 0},
      's' : {index: 2, sign: -1, active: 0},
      'q' : {index: 0, sign: 1, active: 0},
      'e' : {index: 0, sign: -1, active: 0},
    },
